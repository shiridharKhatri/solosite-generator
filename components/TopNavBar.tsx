      ...
      <div className="flex justify-between items-center px-8 h-20 max-w-[1440px] mx-auto">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="bg-lime-600 hover:bg-lime-700 text-white px-6 py-2.5 rounded-md font-bold text-sm active:scale-95 transition-all shadow-md shadow-lime-200 font-body"
          >
            Create New
          </button>
