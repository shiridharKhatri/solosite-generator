        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-12 col-lg-7 text-center text-lg-start pe-lg-5">
              <span className="text-[10px] fw-bold text-stone-600 uppercase tracking-[0.4em] mb-4 d-block">Hand-Crafted • Botanical • Pure</span>
              <EditableText tagName="h1" value={projectData.hero.title} onChange={(val) => updateHero({ title: val })} className="display-3 fw-bold mb-4" style={{ color: primary, lineHeight: 1.1 }} />
              <EditableText tagName="p" value={projectData.hero.subtitle} onChange={(val) => updateHero({ subtitle: val })} className="fs-5 text-stone-700 mb-5 italic font-serif w-100" style={{ lineHeight: 1.8 }} />
